...
Livewerte erhalten zusaetzlich `original_source`, `last_target_adapter` und `last_target_adapters`. Bestehende Objektkonfigurationen bleiben unveraendert. Ab 33.3.50 baut der Routing-Tab seine Anzeige nur noch aus der Objektkonfiguration auf und zeigt keine Selbst- oder Legacy-Routen mehr an.
